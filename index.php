        ...
        <div class="chatbox__support">
            <div class="chatbox__header">
                ...
                <div class="chatbox__content--header">
                    ...
                    <p class="chatbox__description--header">Hi. My name is Ritu. How can I help you?</p>
                </div>
            </div>
            <div class="chatbox__messages">
                ...
                <div class="messages__item messages__item--visitor">
                            Hello, are you a patient, doctor or admin?
                        </div>
                        <div class="messages__item messages__item--operator">
                            I am a patient!
                        </div>
                        <div class="messages__item messages__item--visitor">
                            Please! <a href="index.php">Register<a> for an appointment..or  Having an account?..
                            <a href="index1.php">login here<a>
                        </div>
                        <div class="messages__item messages__item--operator">
                           Thank you..
                        </div>
                        ...
                        <div class="messages__item messages__item--visitor">
                           Yes Doctor Please! <a href="index.php">login here<a>..
                        </div>
                        <div class="messages__item messages__item--operator">
                           Thank you..
                        </div>
